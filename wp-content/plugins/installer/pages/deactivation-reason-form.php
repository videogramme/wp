...
switch($extension_type)
{
    case 'plugin':
        ...
        $language['describe_uninstalling_reason'] = __('Please describe the reasons for uninstalling:', 'installer');//Can you describe the reasons why you are switching from the theme
    ...
    case 'theme':
        ...
        $language['describe_uninstalling_reason'] = __('Please describe the reasons for switching from the current theme:', 'installer');
