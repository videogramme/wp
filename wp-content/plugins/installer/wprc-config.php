...
define('WPRC_PLUGINS_API_QUERY_PLUGINS_PER_PAGE',6); // the number of pages from each repository
define('WPRC_THEMES_API_QUERY_THEMES_PER_PAGE',6); // the number of pages from each repository
